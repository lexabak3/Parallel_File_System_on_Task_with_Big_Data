...
if __name__ == "__main__":
    ...
    (x, y), (x_test, y_test) = load_data(NUM_TRAIN_SAMPLES)
    ...
    print('data download time: ', data_download)
    print('data download time: ', data_download_seconds)

    data_dub = str(end_data_dub - start_data_dub)
    data_dub_seconds = str((end_data_dub - start_data_dub).total_seconds())
    print('time_dub: ', data_dub)
    print('time_dub: ', data_dub_seconds)
